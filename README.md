...
This repository contains the code for the paper Lamothe, Obliger-Debouche, et al. "A large annotated dataset of vocalizations by common marmosets" (1), a marmoset vocalization dataset available on Zenodo (2). It includes scripts for data preprocessing, vocalization detection, and classification using a pre-trained deep learning model.
