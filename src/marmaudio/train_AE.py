...
if __name__ == "__main__":
    ...
    for epoch in range(nepoch):
        ...
        save(optimizer.state_dict(), os.path.join(args.root_experiment_folder, 'optimizer.stdc'))
        save(scheduler.state_dict(), os.path.join(args.root_experiment_folder, 'scheduler.stdc'))
